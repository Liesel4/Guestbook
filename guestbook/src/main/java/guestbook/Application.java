...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "first!!!", "h4xx0r@test.de"), //
					new GuestbookEntry("Arni", "Hasta la vista, baby", "Arni@test.de"), //
					new GuestbookEntry("Duke Nukem", "It's time to kick ass and chew bubble gum. And I'm all out of gum.", "duke@nukem.com"), //
					new GuestbookEntry("Gump1337",
							"Mama always said life was like a box of chocolates. You never know what you're gonna get.", "forest@gump.de")) //
